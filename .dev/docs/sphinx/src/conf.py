# -*- coding: utf-8 -*-
#
# Primer Documentation build configuration file, created by
# sphinx-quickstart on Tue Jan 24 12:54:14 2017.
#
...
html_short_title = u'Documentation 1.x'
...
htmlhelp_basename = 'PrimerDocumentation'
