			...
			<div class="page-content">
				...
				<?php if ( primer_has_active_categories() ) : ?>
					...
					<div class="widget widget_categories">
						...
						<h2 class="widget-title"><?php _e( 'Most Used Categories', 'primer' ) ?></h2>
				...
				<?php
					...
					$archive_content = '<p>' . sprintf( __( 'Try looking in the monthly archives. %1$s', 'primer' ), convert_smilies( ':)' ) ) . '</p>';
